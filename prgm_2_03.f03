...
!     values.
!     Specifically, the user provides the particle mass, box length, and
!     quantum
...
!     Variable Declarations
      ...
      real::m,l,tMatrixElement,vMatrixElement,PIB_1D_Modified_Hamiltonian_Element,pi,b
...
!     The end of the job...
!
      PIB_1D_Modified_Hamiltonian_Element = PIB_1D_T_Element(m,l,n1,n2)+PIB_1D_V_Element(b,m,l,n1,n2)
      write(*,2000) n1,n2,PIB_1D_Modified_Hamiltonian_Element
  999 continue
...
!
      if(n1.eq.n2) then
      PIB_1D_T_Element=((3.14*n1)/4*l**2)*(-Sin(3.14*2*n1)+2*3.14*n1)
      else
      PIB_1D_T_Element=0
      endIf
!
